"""Advanced batch run with progress tracking and resume capability."""
...
def generate_all_cases():
    """Generate all valid cases for n=7 to 14, k=6, with all valid t values."""
    cases = []
    
    m = 45  # Fixed population size
    
    for n in range(7, 15):  # n = 7 to 14
        k = 6
...
def main():
    ...
    print("="*70)
    print("ADVANCED BATCH RUN: n=7 to 14, k=6")
    print("="*70)
